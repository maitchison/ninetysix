...
fc: Frequency cutoff}
function lowPass(x: tSoundEffect;fc: single): tSoundEffect;
var
  i: int32;
  alpha: single;
  y: tSoundEffect;
...
{compulate a low pass filter via IIR filter
fc: Frequency cutoff}
function highPass(x: tSoundEffect;fc: single): tSoundEffect;
var
  i: int32;
  alpha: single;
  y: tSoundEffect;
...
fc: Frequency cutoff}
function butterworth(x: tSoundEffect;fc: single): tSoundEffect;
var
  i: int32;
  w0, alpha, Q: single;

{
Sand simulation using fabric.

This works by storing 'impact' in a grid, and updating it using
simple physics approximations. This impact is then transfered to
particles on the grid. The particles may only move one tile per update.

Purpose: See how fast we can get this to go, and check if method-1,
or method-2 is needed.

 - [ ] benchmark method-1
 - [ ] fast MMX method-1 implication
 - [ ] implement transfer to particles
 - [ ] see how this looks
 - [ ] implement method-2
 - [ ] fast MMX method-2 implementation
...
begin
  ...
  updateImpact := @UpdateImpact_Method1_MMX;

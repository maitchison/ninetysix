...
const
  {TODO: from CWD}
  SRC_ROOT = 'c:\masters\destruct';
  DST_ROOT = 'c:\dev\destruct\';
...
begin
  ...
  processFolder(SRC_ROOT, joinPath(DST_ROOT, 'res'), ftPNG);
  processFolder(SRC_ROOT, joinPath(DST_ROOT, 'res'), ftWAVE);
